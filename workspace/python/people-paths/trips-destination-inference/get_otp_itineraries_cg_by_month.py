...
#user_trips_file = os.getcwd() + "/data/input/2019_05_13_bus_trips.csv"
    ...
    if (file_date.dayofweek == 6):
        ...
        try:
            ...
            otp_legs_df.to_csv(output_folder_path + '/' + file_name + '_otp_itineraries.csv2',index=False)
